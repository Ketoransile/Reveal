...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-950 p-4 relative overflow-hidden">
            ...
            <Card className="w-full max-w-md glass-card-strong border-white/10 relative z-10 animate-in fade-in zoom-in-95 duration-700 delay-100 slide-in-from-bottom-8 shadow-[0_8px_30px_rgba(0,0,0,0.3)]">
                <CardHeader className="space-y-1 pb-6 text-center">
                    <div className="flex justify-center mb-6">
                        <div className="w-14 h-14 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center shadow-[0_0_30px_rgba(16,185,129,0.4)] ring-2 ring-white/20 transition-all">
