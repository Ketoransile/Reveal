...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-950 p-4 relative overflow-hidden">
            ...
            <div className="absolute bottom-0 right-0 w-[800px] h-[800px] bg-emerald-600/10 rounded-full blur-[120px] pointer-events-none opacity-40 animate-pulse" />

            <Card className="w-full max-w-md border-white/10 bg-slate-900/30 backdrop-blur-2xl relative z-10 animate-in fade-in zoom-in-95 duration-700 delay-100 slide-in-from-bottom-8 shadow-[0_8px_30px_rgba(0,0,0,0.3)]">
                <CardHeader className="space-y-1 pb-6 text-center">
                    <Link href="/" className="flex justify-center mb-6 group">
                        <div className="w-14 h-14 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center shadow-[0_0_30px_rgba(16,185,129,0.4)] ring-2 ring-white/20 group-hover:shadow-[0_0_50px_rgba(16,185,129,0.7)] transition-all group-hover:scale-105 cursor-pointer">
                            <span className="text-black font-bold text-2xl">R</span>
                        </div>
                    </Link>
                    <CardTitle className="text-3xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-white to-slate-400">Create your account</CardTitle>
                ...
                <CardContent className="grid gap-6">
                    ...
                    {success && (
                        <div className="p-5 rounded-xl bg-emerald-950/50 border border-emerald-500/50 text-emerald-200 text-sm text-center animate-in fade-in zoom-in-95">
                            <div className="w-12 h-12 bg-emerald-500/20 rounded-full flex items-center justify-center mx-auto mb-3 text-emerald-400 ring-2 ring-emerald-500/30">
                                <CheckCircle2 className="w-6 h-6" />
                            </div>
                            <p className="font-semibold mb-1">Account created successfully!</p>
                            <p className="text-xs text-emerald-300/80">Check your email to confirm your registration.</p>
                        </div>
                    )}
